...
const NAV_SECONDARY: NavItem[] = [
  { label: "Profile", to: "/client/profile", icon: "ri-user-3-line" },
];
      ...
      >
        ...
        <div className="px-3 pb-3">
          <button
            ...
            className="mt-2 flex w-full items-center gap-3 rounded-md px-3 py-2 text-sm font-medium text-foreground-600 hover:bg-background-100 hover:text-foreground-900 transition-colors cursor-pointer"
          >
