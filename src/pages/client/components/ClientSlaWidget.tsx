/**
 * Client SLA summary from live tickets in the current project scope.
 */
...
export default function ClientSlaWidget() {
    ...
    <div className="flex flex-col gap-5 sm:flex-row sm:items-center">
      ...
      <div className="flex-1 min-w-0">
        <p className="text-xs text-foreground-500">
          ...
          <span className="font-semibold text-foreground-900">{counts.active} active requests</span>{" "}
          for your department
        </p>
