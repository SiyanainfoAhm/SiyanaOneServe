...
export interface Project {
  ...
  code: string;
  organization: string;
  status: "Active" | "On Hold" | "Inactive" | "Closing" | "Completed";
  manager: string;
...
export const projects: Project[] = [
  ...
  { id: "p7", name: "HAU Examination System", code: "HAU-EXM", organization: "HAU", status: "On Hold", manager: "Rahul Verma", managerInitials: "RV", progress: 34, openTickets: 3, totalTickets: 29, slaHealth: 88, category: "Software & Application", started: "Jun 2025", deadline: "Aug 2027", slaHours: { Critical: 8, High: 24, Normal: 48, Low: 96 } },
  ...
  { id: "p10", name: "MGSU Campus Wi-Fi Portal", code: "MGSU-WIF", organization: "MGSU", status: "Closing", manager: "Imran Sheikh", managerInitials: "IS", progress: 96, openTickets: 2, totalTickets: 33, slaHealth: 98, category: "Technical Support", started: "Oct 2024", deadline: "Oct 2026", slaHours: { Critical: 8, High: 24, Normal: 48, Low: 96 } },
  { id: "p11", name: "HAU Library Management", code: "HAU-LIB", organization: "HAU", status: "Completed", manager: "Divya Menon", managerInitials: "DM", progress: 100, openTickets: 0, totalTickets: 46, slaHealth: 99, category: "Software & Application", started: "May 2024", deadline: "May 2026", slaHours: { Critical: 8, High: 24, Normal: 48, Low: 96 } },
  { id: "p12", name: "SHM Field Worker App", code: "SHM-FLD", organization: "State Health Mission", status: "On Hold", manager: "Rahul Verma", managerInitials: "RV", progress: 28, openTickets: 1, totalTickets: 22, slaHealth: 90, category: "Software & Application", started: "Jul 2025", deadline: "Jan 2027", slaHours: { Critical: 4, High: 24, Normal: 48, Low: 96 } },
];

export const projectOrganizationOptions = ["All Organizations", "MGSU", "HAU", "Department of Revenue", "State Health Mission"];
export const projectStatusOptions = ["All Statuses", "Active", "On Hold", "Inactive", "Closing", "Completed"];
export const projectEditableStatusOptions = ["Active", "On Hold", "Inactive", "Closing", "Completed"];
...
export const defaultProjectDocuments: ProjectDocument[] = [
  ...
  { id: "d2", name: "SLA Agreement — Signed", kind: "PDF", size: "640 KB", updated: "02 Sep 2026" },
